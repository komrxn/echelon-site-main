  ...
  soon: {
    ...
    office: {
      ...
      bubbles: {
        ...
        coder: 'Ariza qabul botini tugatdim — testlar yashil',
      },
      handoffs: {
        recruiter: 'Rekruter — hisobot topshirildi: uch kishi suhbatga tayyor',
        coder: 'Koder — hisobot topshirildi: bot ko’rsatishga tayyor',
      },
    ...
    cctv: {
      ...
      alert: 'Kassa 2: to’rt kishilik navbat, bitta kassa ochiq. Ikkinchi xodim to’rtinchi daqiqa telefonda.',
